...
<main>
    ...
    <hr class="garis">
<form id="myForm" method="POST" action="proses_edit_sarana.php" enctype="multipart/form-data">
...
document.getElementById('area-select').addEventListener('change', function () {
    ...
    fetch('get_kegiatan_admin.php?id_area=' + areaId)
        .then(res => res.json())
        .then(data => {
...
document.getElementById('kegiatan-select').addEventListener('change', function () {
    ...
    fetch('get_kategori_waktu_admin.php?id_kegiatan=' + kegiatanId)
        .then(res => res.json())
        .then(data => {
