...
<main>
    <form method="POST" action="simpan_penyewaan.php" enctype="multipart/form-data">
...
$(document).ready(function () {
   ...
   $('#next-step').click(function () {
    ...
    $.post('get_rentang_waktu.php', { id_waktu: waktu_id }, function (data) {
        try {
    ...
    $.post('get_area.php', { sarpras_id: idSarpras }, function (response) {
    ...
    $('#area-terpilih').change(function () {
        ...
        $.post('get_kegiatan.php', { area_id }, function (response) {
    ...
    $('#jenis_kegiatan').change(function () {
        ...
        $.post('get_kategori_waktu.php', { kegiatan_id }, function (response) {
   ...
   function getHarga() {
    ...
    $.post('get_harga.php', data, function (response) {
